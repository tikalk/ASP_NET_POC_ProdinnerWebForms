<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Countries.aspx.cs" Inherits="ProdinnerWebForms.Countries" %>
...
<%if(Msg != null)
  ...
  <div class="topmenu">
    ...
    <asp:HiddenField runat="server" ID="eId" />
        <div class="efield">
            <div class="elabel"><%=Mui.Name %>:</div>
            <div class="einput"><asp:TextBox runat="server" ID="eName" ValidationGroup="g1"></asp:TextBox></div>
    ...
    <o:AjaxList runat="server" ID="lstItems" SearchUrl="~/svc/Aja.svc/CountriesSearch" />
