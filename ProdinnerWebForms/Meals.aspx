<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Meals.aspx.cs" Inherits="ProdinnerWebForms.Meals" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="f1" style="display: none;" class="inputform">
        ...
        <div class="efield">
            <div class="elabel">
                <%=Mui.Description %>:</div>
            <div class="einput">
                <asp:TextBox runat="server" ID="eDescription" TextMode="MultiLine" Rows="5"></asp:TextBox></div>
        </div>
    ...
    %>
    <br />
    <%=Mui.Name %>: <input type="text" id="txtSearch" /> <%=Mui.Description %>: <input type="text" id="txtDescription"/>
    <button type="button" id="bSearch" class="bt">
        <%=Mui.Search %></button>
    <o:AjaxList runat="server" ID="lstItems" SearchUrl="~/svc/Aja.svc/MealsSearch" CssClass="mealsList" />
